    ...
    public function generateReport(Request $request)
{
    ...
    // Raw data passed for tables
    $tableData = [
        'salesPerItem' => session('salesPerItem'),
        'salesByEvent' => session('salesByEvent'),
        'monthlyItemRevenue' => session('monthlyItemRevenue'),
        'eventRevenue' => session('eventRevenue'),
    ];
