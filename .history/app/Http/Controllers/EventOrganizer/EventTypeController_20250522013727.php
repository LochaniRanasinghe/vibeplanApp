...
class EventTypeController extends Controller
{
    ...
    {
        return view('event-organizer.event-types.index');
    }
    ...
    {
        return view('event-organizer.event-types.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('event_organizer.event-types.index');
    }
    ...
    {
        return view('event-organizer.event-types.show', compact('eventType'));
    }
    ...
    public function getEventTypes(Request $request)
    {
        try {
            ...
            return DataTables::of($query)
                ...
                ->addColumn('created_at', fn($eventType) => $eventType->created_at
                    ? Carbon::parse($eventType->created_at)->format('Y-m-d')
                    : 'N/A')
                ->addColumn('actions', fn($eventType) =>
                    view('event-organizer.event-types.components.actions', ['eventType' => $eventType])->render()
                )
