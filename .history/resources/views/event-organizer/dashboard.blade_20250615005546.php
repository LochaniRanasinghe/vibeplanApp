...
@section('content')
    <div class="card" style="border-radius: 15px;">
        <div class="card-body">
            <form id="reportForm" method="POST" action="{{ route('event_organizer.dashboard.download-report') }}">
                @csrf
                <input type="hidden" name="incomePerEventChart" id="incomePerEventChart">
                <input type="hidden" name="topItemsChart" id="topItemsChart">
