    ...
    <div class="card" style="border-radius: 15px;">
        <div class="card-body">
            <div class="container-fluid mt-3">
                ...
                <div class="card mb-4">
                    <div class="card-header">Revenue by Event Type</div>
                    <div class="card-body">
...
@section('scripts')
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            const itemsSold = eventLabels.map(type => eventRevenue[type].items.join(", "));
                        ...
                        tooltip: {
                            callbacks: {
                                afterLabel: function(context) {
                                    return 'Items: ' + itemsSold[context.dataIndex];
                                }
                            }
                        }
                    },
