...
<body>
    ...
    <div class="section">
        ...
        @if (count($tableData['salesPerItem']) > 0)
            <table>
                <thead>
                    <tr>
                        <th>Item</th>
    ...
    <div class="section">
        ...
        @if (!empty($tableData['salesByEvent']) && count($tableData['salesByEvent']) > 0)
            <table>
                <thead>
                    <tr>
                        <th>Event</th>
    ...
    <div class="section">
        ...
        @if (count($tableData['monthlyItemRevenue']) > 0)
    ...
    <div class="section">
        ...
        @if (count($tableData['eventRevenue']) > 0)
            <table>
                <thead>
                    <tr>
                        <th>Event Type</th>
