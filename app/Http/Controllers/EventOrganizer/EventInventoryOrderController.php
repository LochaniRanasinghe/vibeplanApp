...
class EventInventoryOrderController extends Controller
{
    ...
    {
        return view('event-organizer.inventory-orders.index');
    }
    ...
    {
        return view('event-organizer.inventory-orders.create');
    }
    ...
    public function show(EventInventoryOrder $inventoryOrder)
    {
        ...
        return view('event-organizer.inventory-orders.show', compact('inventoryOrder'));
    }
        ...
        try {
            ...
            return DataTables::eloquent($query)
                ...
                ->addColumn('actions', function ($order) {
                    return view('event-organizer.inventory-orders.components.actions', compact('order'))->render();
                })
