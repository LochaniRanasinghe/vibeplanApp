    ...
    <div class="card" style="border-radius: 15px;">
        <div class="card-body">
            <div class="row mt-3 mb-5 mx-2">
                <b>
                    <h6 style="text-transform: uppercase; font-weight: bold;" class="text-center mb-4">Edit Scheduled Events</h6>
                </b>

                <form action="{{ route('admin.custom-events.update', $customEvent->id) }}" method="POST">
                    @csrf
                    @method('PUT')

                    {{-- READ-ONLY FIELDS FROM EVENT REQUEST --}}
                    <div class="row mb-3">
                        <div class="col-md-6">
                    ...
                    {{-- EDITABLE FIELDS FROM CUSTOM EVENT --}}
                    <div class="row mb-3">
                        <div class="col-md-4">
                    ...
                    <div class="text-end">
                        <a href="{{ route('admin.custom-events.index') }}" class="btn btn-outline-secondary me-2 px-4">Return
                            Back</a>
