    ...
    <div class="card" style="border-radius: 15px;">
        <div class="card-body">
            <div class="row mt-3 mb-5 mx-2">
                ...
                <form action="{{ route('inventory_staff.inventory-orders.update', $inventoryOrder->id) }}" method="POST">
                    ...
                    <div class="row mb-3">
                        <div class="col-md-6">
                            ...
                            <input type="text" name="quantity" class="form-control readonly-field"
                                value="{{ $inventoryOrder->quantity }}" readonly>
                        </div>
                        <div class="col-md-6">
